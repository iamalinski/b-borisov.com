...
@section('title', 'Редактиране на раздел')
@section('breadcrumb', 'Редактиране на раздел')

@section('header', 'Редактиране на раздел')
@section('subheader', 'Промяна на името на раздела')

@section('content')
<form action="{{ route('admin.packages.section.update', $section) }}" method="POST">
    @csrf
    @method('PUT')
